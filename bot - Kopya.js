...
client.on('message', msg => {
  ...
  if (!msg.content.startsWith(prefix)) {
  	...
  	if (msg.content.toLowerCase() === prefix + "ping") {
		msg.reply("Botun Ping" + " " + bot.ping + " *ms* ");
		}
	if (msg.content.toLowerCase() === prefix + 'sigarayak') {
		...
		msg.edit(' :smoking:  ');
		msg.edit(' Sigaram Bitti! **Dikkat Bu Espiri Amaçlıdır ! Sigara Sağlığa Zararlı ve 18 Yaşından Küçüklerin Kullanması Tavsiye Etmiyoruz !** ');
  }
